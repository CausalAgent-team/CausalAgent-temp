...
export const messages = {
  zh: {
    ...
    adminPortal: '管理后台', ragEvalPortal: 'RAG 评测台', logout: '退出登录', close: '关闭', back: '返回',
  ...
  en: {
    ...
    adminPortal: 'Admin Console', ragEvalPortal: 'RAG Lab', logout: 'Logout', close: 'Close', back: 'Back',
